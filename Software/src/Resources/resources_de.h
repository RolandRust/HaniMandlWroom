...
char SETUP_DROPPRODECTION[] = "Setup Tropfschutz";
...
char OPEN_DROPPROTECTION[]  = "Öffne Tropfschutz";
char CLOSE_DROPPROTECTION[] = "Schliesse Tropfschutz";
char SPEED_DROPPROTECTION[] = "Geschwindigkeit";
char WAIT_TO_OPEN_DP[]      = "Warten zum öffnen";
