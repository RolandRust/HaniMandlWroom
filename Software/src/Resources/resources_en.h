char LANGUAGE1[]            = "Language";
char LANGUAGE2[]            = "English";
...
char STOP_AP[]              = "Stop AP"               //Stop access point
char PLEACE_WAIT[]          = "Please wait"
...
char COLORSCHEME[]			    = "Colorscheme";                    //only used for TFT
char MARKER_COLOR[]			    = "Marker color";                   //only used for TFT
char CHANGE_ROTATION[]      = "Change rotation"                 //only used for TFT
char FONT[]                 = "Font"                            //only used for TFT
...
char SW_RELEASE[]           = "SW Release";
char WLAN_SETTINGS[]        = "WLAN Settings";
char SSID[]                 = "SSID";
