files = ["resources_de.h", "resources_en.h", "resources_sk.h"]
#files = ["resources_de.h", "resources_en.h", "resources_sk.h","resources_de.h", "resources_en.h", "resources_sk.h","resources_de.h", "resources_en.h", "resources_sk.h"]
variables = {}
x = []
...
for key in variables.keys():
  line = "extern char %s[%s][30];\n" % (variables[key][0], len(files))
  datei.write(line)
datei.close()
datei = open("resources.cpp", 'w')
datei.write("#include \"resources.h\"\n")
for key in variables.keys():
  line = "char %s[%s][30] = {" % (variables[key][0], len(files))
